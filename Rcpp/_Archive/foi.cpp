...
// designed to be used with the original code
// j - array index 0-4
// t - month 1-12
// [[Rcpp::export]]
double foi(arma::vec Y, int t, int j, List params){
  ...
  arma::uvec row_indx = arma::linspace<arma::uvec>(0,24,n_age);
  ...
  if((t+shift)>12) {
    c_season = xi*cos(0.018181818*M_PI*(t + shift - 12 - 1));
  } else {
    c_season = xi*cos(0.018181818*M_PI*(t + shift - 1));
  }
...
// t - month
// [[Rcpp::export]]
double foi2(arma::vec Y, double t, int j, List params){
  //  inf_state_names = c("UV0I0", "UV0IR", "LV0I0", "LV0IR","UV1I0", "UV1IR", "LV1I0", "LV1IR","UV2I0", "UV2IR",
  //      "LV2I0", "LV2IR","UV3I0", "UV3IR", "LV3I0", "LV3IR")
